...
function Home() {
  return (
    <div className='overflow-hidden'>
      <div className="w-screen h-screen overflow-hidden relative before:block before:absolute before:bg-black/30 before:h-full before:w-full before:top-0 before:left-0 before:z-10 ">
      ...
      <div className="bg-black/60 py-10 px-4">
        <div className="max-w-screen-lg mx-auto md:flex md:justify-between md:items-center">
          <div className="max-w-xl">
            ...
            <p className="text-base text-gray-300 text-center md:text-left ">Vision360° is your trusted digital partner, offering quality services and innovative solutions. Our flexible rates for beginners ensure confidence in overcoming obstacles. Let us lead you to success with passion and expertise</p>
          </div>
