  ...
  return (
    <div className="flex flex-col md:flex-row">
      ...
      <div className="w-full mt-6 md:mt-0 p-3 order-first md:order-2 md:max-w-[650px] md:w-1/2 md:pt-12 md:pb-12 md:ml-11">
        ...
        <div className="w-full h-1/3 max-h-[100px] overflow-hidden backdrop-blur-lg bg-white/60 dark:bg-black/60 rounded-full shadow-2xl flex items-center space-x-4 p-2">
          <div className=" md:ml-9 md:w-20 md:h-16 flex-shrink-0 flex flex-col items-center justify-center">
            ...
            <p className=" font-semibold text-xs text-center hidden md:block text-black dark:text-white">Innovative Ideas</p>
          </div>
          ...
          <div className="md:w-20 md:h-16 flex-shrink-0 flex flex-col items-center justify-center">
            ...
            <p className=" font-semibold text-xs text-center hidden md:block text-black dark:text-white">Responsive Web Site</p>
          </div>
          <div className="w-px h-2/3 bg-blue-500"></div>

          <div className="md:w-20 md:h-16 flex-shrink-0 flex flex-col items-center justify-center">
            <img src="/home-imgs/Marketing digital.png" alt="Service 3" className="h-16 w-16" />
            <p className=" font-semibold text-xs text-center hidden md:block text-black dark:text-white">Social Media Enhancement</p>
          </div>
          <div className="w-px h-2/3 bg-blue-500"></div>
          ...
          <div className="hidden md:flex md:w-20 md:h-16 flex-shrink-0 flex-col items-center justify-center">
            ...
            <p className=" font-semibold text-xs text-center hidden md:block text-black dark:text-white">24/7 Availability</p>
          </div>
      ...
      <div className="w-full md:w-1/2  md:mt-0 md:order-1 ">
        <div className="flex flex-col m-4 md:ml-8  justify-start items-center md:justify-center min-h-screen">
          <div className="w-full backdrop-blur-lg bg-white/80 dark:bg-black/60 rounded-3xl shadow-2xl p-4">
            ...
            <h3 className='text-3xl font-bold text-black dark:text-white'>About US</h3> 
            </div>
            <br />
