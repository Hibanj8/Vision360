    ...
    <div>
        ...
        <div className="flex flex-wrap -mx-4">
         <div className="w-full px-4">
            ...
            <div className="container m-auto px-6 text-gray-300 md:px-12 xl:px-0">
                <div className="mx-auto grid gap-6 md:w-3/4 lg:w-full lg:grid-cols-3">
                    <div className="bg-black/60 backdrop-blur-lg rounded-2xl shadow-xl px-8 py-12 sm:px-12 lg:px-8">
