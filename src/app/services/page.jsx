        ...
        <div className="flex flex-wrap -mx-4">
         <div className="w-full px-4">
            <div className="text-center mx-auto mb-12 lg:mb-20 max-w-[400px] md:max-w-[510px]">
               ...
               <p className="text-white duration-700 dark:text-black text-body-color">
            ...
            <div className="container m-auto px-6 text-gray-600 duration-700 dark:text-gray-300 md:px-12 xl:px-0">
                <div className="mx-auto grid gap-6 md:w-3/4 lg:w-full lg:grid-cols-3">
                    <div className="bg-white/60 duration-700 dark:bg-black/60 backdrop-blur-lg rounded-2xl shadow-xl px-8 py-12 sm:px-12 lg:px-8">
