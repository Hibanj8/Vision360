        ...
        <div className="-mx-4 flex flex-wrap lg:justify-between mb-10 p-5 md-p-0 md:ml-32">
          <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
            <div className="mb-12 max-w-[570px] lg:mb-0">
              ...
              <h2 className="mb-6 text-[32px] font-bold text-white duration-700 dark:text-black sm:text-[40px] lg:text-[36px] xl:text-[40px]">
              ...
              <div className="mb-8 flex w-full max-w-[370px]">
                ...
                <div className="w-full">
                  ...
                  <p className="text-white duration-700 dark:text-black">
