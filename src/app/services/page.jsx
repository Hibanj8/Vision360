        ...
        <div className="flex flex-wrap -mx-4">
         <div className="w-full px-4">
            <div className="text-center mx-auto mb-12 lg:mb-20 max-w-[400px] md:max-w-[510px]">
               <span className="uppercase font-semibold text-lg text-primary mb-2 block text-purple-900">
               Our Services
               </span>
               <h2
                  className="
               ...
               <p className="text-white dark:text-black text-body-color">
            ...
            <div className="container m-auto px-6 text-gray-600 dark:text-gray-300 md:px-12 xl:px-0">
                <div className="mx-auto grid gap-6 md:w-3/4 lg:w-full lg:grid-cols-3">
                    <div className="bg-white/60 dark:bg-black/60 backdrop-blur-lg rounded-2xl shadow-xl px-8 py-12 sm:px-12 lg:px-8">
