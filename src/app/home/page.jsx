      ...
      <div className="w-screen h-screen overflow-hidden relative before:block before:absolute before:dark:bg-black/30 before:h-full before:w-full before:top-0 before:left-0 before:z-10 ">
        ...
        <div className="relative z-20 max-w-screen-lg mx-auto md:grid md:grid-cols-6 h-full items-center  flex-col lg:flex-row md:mt-0 mt-28">
          <div className="col-span-3 mb-4 p-6 md:p-0 lg:mb-0">
            ...
            <h1 className="text-white dark:text-black font-extrabold text-5xl mb-8 text-center md:text-left">Vision360° makes digital dreams a reality.</h1>
            ...
            <a href="/contact">
              <button className="ml-28 md:ml-0 mt-8 rounded-3xl text-white dark:text-black uppercase py-3 font-semibold text-base px-10   border-white hover:bg-white/60 hover:text-black  border dark:border-black hover:dark:bg-black/60 hover:dark:text-white duration-500" > CONTACT </button>
            </a>
          </div>
      ...
      <div className="bg-black/60 py-10 px-4">
        <div className="max-w-screen-lg mx-auto md:flex md:justify-between md:items-center">
          <div className="max-w-xl">
            <h2 className="font-black  text-white text-3xl mb-4 text-center md:text-left">Vision360° - Tailored Price Flexibility for Beginners</h2>
            <p className="text-base text-gray-300 text-center md:text-left ">Vision360° is your trusted digital partner, 
         ...
         <a href="/services"><button className="text-white ml-28 md:ml-0 rounded-3xl uppercase py-3 text-base px-10 border border-white font-semibold hover:bg-white/60 hover:text-black duration-500 my-8 md:my-0">SERVICES</button>
        </a> 
        </div>
      </div>
    </div>
